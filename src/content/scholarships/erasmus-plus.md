...
applicationDeadline: ""
sources:
  - label: "Erasmus+ - Portal oficial UE"
    url: "https://erasmus-plus.ec.europa.eu/"
  - label: "Manual ICM para organizaciones participantes (UE, 2024)"
...
- Idioma: certificado de inglés B2 para destinos de habla no hispana (ORT); los destinos de habla hispana no lo exigen.
- Carta de motivación (máximo 400 palabras en ORT) y entrevista de selección.
- No haber participado previamente en el programa de intercambio de la universidad de origen.

## Cómo Postular

A través de la **oficina internacional de tu universidad**: ORT (Coordinación de Intercambio Estudiantil) y UDELAR (Servicio de Relaciones Internacionales y UPCC de cada Facultad) publican convocatorias internas con plazos, destinos y requisitos; el coordinador académico de la carrera autoriza la inscripción.

El pago de la beca se realiza **en destino, una vez iniciada la movilidad**: el estudiante adelanta el pasaje y la reserva de alojamiento. ORT cobra una tasa de intercambio a los seleccionados.
