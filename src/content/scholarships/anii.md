...
sources:
  ...
  - label: "ANII - Programa de Becas de Posgrado Nacional"
    url: "https://anii.org.uy/apoyos/formacion/276/programa-de-becas-de-posgrado-nacional"
  - label: "ANII - Posgrados Nacionales 2026 (información preliminar)"
    url: "https://anii.org.uy/apoyos/formacion/688/posgrados-nacionales-2026-informacion-preliminar"
  - label: "ANII - Becas de Posdoctorado Nacional"
...
Estipendio mensual directo al becario, según la modalidad (montos fijados por resolución, valores 2026):
...
**A quién está dirigida:** uruguayos o extranjeros residentes en el país, para maestrías, doctorados y posdoctorados en Uruguay o en el exterior.

- Ser uruguayo o extranjero residente en el país.
- Estar inscripto o aceptado en un programa de posgrado reconocido por la autoridad competente en Uruguay (la inscripción condicional es admisible de forma excepcional).
- No estar comprendido en el régimen de dedicación total ni superar las 30 horas semanales de actividad laboral, docente o de investigación (no aplica a becas que se realizan completamente en el exterior).
- No haber recibido otra beca ANII del mismo nivel (no se acepta una segunda maestría ni un segundo doctorado).
- Prioridad para candidatos menores de 38 años al cierre del llamado (no excluyente). No se financian maestrías en Administración (MBA).
- Una única postulación por llamado y a una sola línea de apoyo.
