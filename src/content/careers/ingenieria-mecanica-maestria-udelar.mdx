...
description: "La Maestría tiene como objetivo profundizar en las áreas de conocimiento de laIngeniería Mecánica, destacando el diseño mecánico, termodinámica aplicada,mecatrónica y procesos industriales. Promover la formación de recursos humanosaltamente calificados capaces de afrontar y resolver con solvencia y creatividad lasnecesidades de la sociedad en el área."
startDate: ""
...
sources:
  - label: 'Catálogo de Posgrados Udelar (CAP)'
    url: 'https://cap.posgrados.udelar.edu.uy/detallesPosgrado.php?idServicio=8&idPosgrado=57'
  - label: 'Ficha PDF'
    url: 'https://cap.posgrados.udelar.edu.uy/fpdf/posgradoPDF.php?idServicio=8&idPosgrado=57'
---
