...
sources:
  - label: 'Página oficial de la carrera'
    url: 'https://ie.ort.edu.uy/doctorado-en-educacion'
  - label: 'Plan de estudios'
    url: 'https://ie.ort.edu.uy/doctorado-en-educacion/plan-de-estudios'
...
El Doctorado en Educación es una propuesta pionera para especializarse en el campo educativo y desarrollar investigaciones de vanguardia.

- Énfasis destacado en la promoción de una investigación autónoma y rigurosa
- Generación de conocimiento relevante sobre las ciencias de la educación
- Desarrollo de propuestas que integran teoría y práctica de manera innovadora
...
Para cursar el Doctorado en Educación, los candidatos deben tener formación de grado y postgrado, con los perfiles que se indican a continuación: Formación de grado Título de grado universitario uruguayo, título de grado obtenido en una universidad extranjera (con reconocimiento oficial en el país de origen), o título docente uruguayo (expedido por los institutos de formación docente dependientes o habilitados por la Administración Nacional de Educación Pública). Formación de postgrado Título de maestría o postgrado de especialización, obtenidos en un centro académico con reconocimiento oficial. Estudiantes del exterior Los estudiantes que culminaron una carrera universitaria en el exterior deben presentar el título académico apostillado o una copia notarial del mismo. Se deberá entregar dicha constancia en la bedelía de la escuela de postgrados correspondiente de la Universidad ORT Uruguay, lo que habilita el inicio de los estudios de postgrado.
...
Para obtener el título de Doctor/a en Educación es necesario haber cursado y aprobado todos los seminarios y talleres. Asimismo, haber presentado y aprobado la tesis doctoral. Los candidatos doctorales deberán realizar un trabajo original y demostrar su capacidad para realizar investigaciones científicas en forma independiente. Además, dicho trabajo debe inscribirse en una de las cinco líneas de investigación del Instituto de Educación: Organización y gestión del sistema educativo Procesos de enseñanza y procesos de aprendizaje Tecnología educativa Profesión docente Políticas educativas
