...
- Nombre oficial: Técnico en Gestión Turística y Hotelera
- Tipo: Tecnicatura
...
- Perfil de egreso: Perfil de los graduados Los Técnicos en Gestión Turística y Hotelera estarán formados para asumir las responsabilidades en diferentes ramas de la industria turística y hotelera, con formación práctica en gestión de operaciones de hoteles, y desarrollando habilidades en gestión digital y administración de actividades del sector turístico. Enfocados en formar mandos medios para: Contribuir al diseño e implementación de políticas organizacionales y sectoriales. Planificar y supervisar operaciones y los procesos de ejecución de actividades sectoriales. Dirigir personal y evaluar su desempeño. Elaborar y analizar información para la toma de decisiones gerenciales.
- Salida laboral: Perfil de los graduados Los Técnicos en Gestión Turística y Hotelera estarán formados para asumir las responsabilidades en diferentes ramas de la industria turística y hotelera, con formación práctica en gestión de operaciones de hoteles, y desarrollando habilidades en gestión digital y administración de actividades del sector turístico. Enfocados en formar mandos medios para: Contribuir al diseño e implementación de políticas organizacionales y sectoriales. Planificar y supervisar operaciones y los procesos de ejecución de actividades sectoriales. Dirigir personal y evaluar su desempeño. Elaborar y analizar información para la toma de decisiones gerenciales.
...
- Página oficial: https://facs.ort.edu.uy/tecnico-en-gestion-turistica-y-hotelera

## Resumen

Estudiar la carrera de Técnico en Gestión Turística y Hotelera forma para asumir responsabilidades en los principales operadores del sector.

- Profundización en herramientas digitales para una gestión eficiente
- Aprendizaje de estrategias de marketing adaptadas al sector turístico
- Preparación para roles de liderazgo en el sector turístico y hotelero
...
**Economía y organización del turismo**

Establece un marco conceptual que caracteriza a la actividad turística, su tipología a nivel internacional y nacional. Presenta el desarrollo turístico sostenible aplicado a destinos y servicios turísticos, tanto en lo global como en lo local. Introduce a los estudiantes en herramientas técnicas de gestión de empresas turísticas y promoción de destinos y servicios turísticos.

**Gestión y administración de empresas**

Capacita al estudiante para lograr objetivos predeterminados, en un entorno con restricciones y mediante el uso de recursos limitados. Al final de este curso los estudiantes entenderán claramente el proceso que siguen los gerentes exitosos y conocerán algunas herramientas de que disponen. Se desarrolla con un enfoque netamente operativo y práctico.
...
**Geografía turística y patrimonio cultural**

Introduce en los principios de la sostenibilidad aplicada al turismo, basada en la conservación y puesta en valor del patrimonio mundial, regional y local. Facilita herramientas técnicas para la gestión del patrimonio, con especial atención en la toma de decisiones sobre su planificación, comercialización y promoción turística.
...
**Gestión y contabilidad hotelera**

Forma en la gestión hotelera, el negocio de alojamiento, la venta de habitaciones, las reservas, las operaciones, la supervisión, el análisis financiero y de costos.

**Marketing digital y publicidad turística**

Capacita en los conocimientos necesarios para incorporar las herramientas digitales en las actividades de investigación, comunicación y comercialización de productos turísticos. Se enfoca en modelos de negocios apoyados en herramientas digitales. Prepara al estudiante para que sea capaz de entender las estrategias y así gestionar los medios digitales para satisfacer las nuevas expectativas del turista.
...
Estudia las estrategias y métodos de fijación de precios, así como los fundamentos de Revenue Management (RM). Se capacita al estudiante para que pueda diseñar estrategias que perimitan la venta del producto adecuado al cliente adecuado, en el momento adecuado, al precio correcto y en el canal correcto. Es decir, utilizar herramientas de análisis, cruzar datos y tomar decisiones para optimizar las ventas y sacar el máximo beneficio.

**Organización y gestión de destinos**

Capacita en la organización y gestión del destino turístico. Introduce al estudiante a los procedimientos de gestión y seguimiento de proyectos en destino. Gestión de las agencias de viaje, incluyendo las agencias online y la importancia de las principales tecnologías en el área.

**Electiva**

Las materias electivas se presentan a título de ejemplo y están sujetas a quorum mínimo. Organización de eventos y relaciones públicas Gestión de alimentos y bebidas Gestión comercial Comunicaciones online y offline
...
Duración 2 años de cursos. Horarios de clase Tres días a la semana, entre el lunes y el jueves, de 19:30 a 22:00. La Universidad ORT Uruguay se reserva el derecho de realizar ajustes de fechas, horarios y contenidos. Los horarios mencionados no incluyen las prácticas. Las inscripciones están sujetas a quorum mínimo por turno.

## Títulos y reconocimientos

Al aprobar todas las materias que componen los dos años de la carrera, los estudiantes alcanzan el título de Técnico/a en Gestión Turística y Hotelera.
...
- [Página oficial de la carrera](https://facs.ort.edu.uy/tecnico-en-gestion-turistica-y-hotelera)
- [Plan de estudios](https://facs.ort.edu.uy/tecnico-en-gestion-turistica-y-hotelera/plan-de-estudios)
