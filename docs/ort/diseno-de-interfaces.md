...
- Nombre oficial: Diseño de Interfaces
- Tipo: Tecnicatura
- Área: Diseño
...
- Perfil de egreso: Perfil de los graduados La carrera forma profesionales competentes en: Diseño y desarrollo de interfaces digitales interactivas. Diseño centrado en la experiencia y la investigación de usuarios (UX/UI). Aplicación de metodologías ágiles y de prototipado digital. Integración de diseño visual, comunicación y programación web. Usabilidad, accesibilidad y estándares de calidad en entornos digitales. Gestión de proyectos de diseño digital.
- Salida laboral: Perfil de los graduados La carrera forma profesionales competentes en: Diseño y desarrollo de interfaces digitales interactivas. Diseño centrado en la experiencia y la investigación de usuarios (UX/UI). Aplicación de metodologías ágiles y de prototipado digital. Integración de diseño visual, comunicación y programación web. Usabilidad, accesibilidad y estándares de calidad en entornos digitales. Gestión de proyectos de diseño digital.
...
- Página oficial: https://fd.ort.edu.uy/diseno-de-interfaces
