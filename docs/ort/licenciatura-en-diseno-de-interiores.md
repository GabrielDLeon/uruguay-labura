...
- Nombre oficial: Licenciatura en Diseño de Interiores
- Tipo: Licenciatura
- Área: Arquitectura
- Modalidad: Híbrido (presencial con opción virtual HyFlex)
- Turno: No encontrado
- Duración: 4 años más 3 meses para la presentación del portafolio
...
- Cupos: No encontrado
- Título intermedio: Diseñador/a de Interiores
...
- Perfil de egreso: Perfil de los graduados El profesional graduado en esta carrera: Logra una formación integral y una visión unitaria del diseño, la tecnología y las ciencias sociales y humanas, que lo habilita para el ejercicio profesional en el medio laboral local y regional. Identifica, investiga, interpreta y resuelve creativamente las demandas de clientes y usuarios, optimizando la solución según necesidades estéticas, funcionales, tecnológicas, económicas, ergonómicas, psicológicas, sociales y culturales. Posee herramientas conceptuales y metodológicas que le permiten desarrollar proyectos capaces de optimizar la calidad del espacio interior y la identidad con el usuario. Cuenta con una preparación conceptual y técnica que le permite un constante proceso de superación personal, adaptado a los cambios y desafíos actuales de la disciplina. Está capacitado para continuar estudios de postgrado en áreas de su interés.
- Salida laboral: Perfil de los graduados El profesional graduado en esta carrera: Logra una formación integral y una visión unitaria del diseño, la tecnología y las ciencias sociales y humanas, que lo habilita para el ejercicio profesional en el medio laboral local y regional. Identifica, investiga, interpreta y resuelve creativamente las demandas de clientes y usuarios, optimizando la solución según necesidades estéticas, funcionales, tecnológicas, económicas, ergonómicas, psicológicas, sociales y culturales. Posee herramientas conceptuales y metodológicas que le permiten desarrollar proyectos capaces de optimizar la calidad del espacio interior y la identidad con el usuario. Cuenta con una preparación conceptual y técnica que le permite un constante proceso de superación personal, adaptado a los cambios y desafíos actuales de la disciplina. Está capacitado para continuar estudios de postgrado en áreas de su interés.
...
- Página oficial: https://fa.ort.edu.uy/licenciatura-en-diseno-de-interiores
