...
- Nombre oficial: Master en Big Data
- Tipo: Maestría
- Área: Ingeniería
...
- Perfil de egreso: Perfil de los graduados Los egresados del Master en Big Data son profesionales con conocimientos y habilidades específicas en la utilización de tecnologías avanzadas de big data. Los egresados tienen probadas competencias en tres aspectos clave: la gestión del ciclo de vida de la analítica de big data en una organización, la infraestructura de software para el almacenamiento y el procesamiento de datos heterogéneos en tiempo real, las técnicas de inteligencia artificial orientadas al análisis predictivo y prescriptivo como soporte para la toma de decisiones y la automatización de su ejecución. Los graduados tienen las habilidades requeridas para formar parte activa en equipos multidisciplinarios de empresas públicas y privadas, organismos gubernamentales y centros de investigación. Pueden participar en la elaboración, liderazgo y ejecución de proyectos complejos sustentados por tecnologías de big data, enfatizando la productividad y la calidad.
- Salida laboral: Perfil de los graduados Los egresados del Master en Big Data son profesionales con conocimientos y habilidades específicas en la utilización de tecnologías avanzadas de big data. Los egresados tienen probadas competencias en tres aspectos clave: la gestión del ciclo de vida de la analítica de big data en una organización, la infraestructura de software para el almacenamiento y el procesamiento de datos heterogéneos en tiempo real, las técnicas de inteligencia artificial orientadas al análisis predictivo y prescriptivo como soporte para la toma de decisiones y la automatización de su ejecución. Los graduados tienen las habilidades requeridas para formar parte activa en equipos multidisciplinarios de empresas públicas y privadas, organismos gubernamentales y centros de investigación. Pueden participar en la elaboración, liderazgo y ejecución de proyectos complejos sustentados por tecnologías de big data, enfatizando la productividad y la calidad.
...
- Página oficial: https://fi.ort.edu.uy/master-en-big-data
