...
- Nombre oficial: Master en Dirección de Comunicación y Marketing
- Tipo: Maestría
- Área: Comunicación
...
- Perfil de egreso: Perfil de los graduados El Master en Dirección de Comunicación y Marketing busca formar profesionales para cumplir un rol gerencial central en las organizaciones contemporáneas. Con ese horizonte, se los prepara para asumir con liderazgo y visión estratégica los desafíos que proponen los sistemas de relaciones comerciales y sociales dentro y fuera de la organización, y responder con eficacia a las necesidades de la problemática empresarial contemporánea.
- Salida laboral: Perfil de los graduados El Master en Dirección de Comunicación y Marketing busca formar profesionales para cumplir un rol gerencial central en las organizaciones contemporáneas. Con ese horizonte, se los prepara para asumir con liderazgo y visión estratégica los desafíos que proponen los sistemas de relaciones comerciales y sociales dentro y fuera de la organización, y responder con eficacia a las necesidades de la problemática empresarial contemporánea.
...
- Página oficial: https://fc.ort.edu.uy/escuela-de-postgrados/master-en-direccion-de-comunicacion-y-marketing

## Resumen

Desarrolla la capacidad de pensar estratégicamente y traduce la percepción y el conocimiento en acciones comunicacionales y comerciales.

- Liderar estrategias combinadas de comunicación y negocios efectivas
- Desarrollar habilidades gerenciales y visión estratégica empresarial
- Fomentar en las empresas relaciones comerciales y sociales sólidas

El postgrado está diseñado para profesionales universitarios interesados en desarrollarse en la dirección de comunicación y marketing en empresas de distinto porte y sectores de actividad, o bien en cumplir funciones gerenciales en entidades públicas o privadas, transformando su perfil profesional con el fin de desempeñar un papel estratégico en la empresa moderna.

El acceso actual a la información permite que las personas cuenten, cada día, con más y más herramientas para participar activamente en la interacción con marcas y empresas.

De esta forma, la gestión de la construcción de marcas y la reputación de las empresas están cada vez más entrelazadas y se potencian cuando se gestionan conjuntamente.

Planes coordinados y con visiones congruentes son elaborados por ejecutivos formados en las áreas de Comunicación y Marketing, con una clara comprensión de las estrategias empresariales, con liderazgos desarrollados y con habilidades de comunicación centradas en los nuevos hábitos de interacción con los medios de comunicación.

Este master busca desarrollar la capacidad de pensar estratégicamente y de traducir la percepción y el conocimiento en acciones comunicacionales y comerciales concretas que permitan conectar con los públicos meta.

La aplicación de técnicas creativas de investigación para la recopilación y análisis de datos que faciliten el entendimiento profundo de las personas, sus motivaciones, opiniones y procesos de decisión se conjuga con las capacidades innovadoras de construcción de marcas e identidades corporativas, los mecanismos para impulsar el producto a través de canales online y offline, las métricas que permiten el seguimiento de la salud de una marca y el manejo estratégico y táctico de las decisiones complejas en las áreas de marketing y comunicación.

Con la activa participación en dinámicas teórico-prácticas, un experimentado equipo de docentes nacionales y extranjeros guiará el proceso de aprendizaje y capacitación en una experiencia de nivel internacional.
...
Electiva internacional Gracias al convenio que mantiene la Facultad de Comunicación y Diseño de la Universidad ORT Uruguay con la Barcelona School of Management —la escuela de negocios de la Universidad Pompeu Fabra (España)—, los estudiantes de sus postgrados pueden cursar materias en Barcelona. Conocé más de este acuerdo: Alianza con Barcelona School of Management Conocé más sobre esta experiencia: Intercambio académico en Barcelona: estudiantes de postgrado se capacitan en protocolo y eventos Dirección comercial y ventas Trabaja los temas relacionados con las decisiones comerciales y de ventas a partir de un conocimiento profundo del proceso de compra del cliente. Pone foco en los factores que contribuyen a una mayor eficacia y eficiencia de la organización de ventas y a un mejor desempeño del jefe de ventas. Estudia sistemas de asignación y compensación de vendedores y desarrollo de planes comerciales alineados con objetivos y estrategias de marketing. Incorpora herramientas del Key Account Management. Investigación de mercados Presenta métodos, herramientas y técnicas para una investigación en marketing que facilite al directivo la toma de decisiones comerciales. Define objetivos de investigación orientados a resolver problemas gerenciales. Estudia el brief de investigación, las fuentes primarias y secundarias de información, las principales técnicas cualitativas y cuantitativas de la disciplina. Capacita para el análisis de datos cualitativos y cuantitativos. Marketing de servicios y relaciones Analiza las particularidades de los intangibles y cómo afectan en la toma de decisiones. Asimismo capacita en los conocimientos de la gestión de la relación con el cliente (CRM) y en las herramientas organizativas para construir una organización de servicios centrada en el cliente y basada en la rentabilidad y la dirección de la relación con el cliente. Capacita en las nuevas herramientas para explotar una base de datos y obtener ventajas competitivas desde un adecuado análisis de la información comercial. Métodos cuantitativos para decisiones gerenciales Provee conocimientos y desarrolla habilidades en metodologías y técnicas de análisis cuantitativo. Los participantes enmarcan y resuelven típicos problemas de negocios, aplican métodos de análisis cuantitativo para mejorar el proceso de decisión e interactúan con expertos del área. Organización orientada al cliente Capacita para orientar la empresa al mercado en cuanto a la inteligencia de marketing, la diseminación de dicha inteligencia a lo largo de la organización y la respuesta de toda la empresa de forma integral al cliente. Capacita para diseñar las métricas adecuadas para la orientación y evaluación de las actividades de marketing. Persona y organización Brinda conocimientos sobre la función y aportes desarrollados por la Psicología Laboral para la comprensión y análisis del comportamiento humano en el trabajo. Aborda el estudio de los fenómenos psicológicos configurados por la peculiar interacción dinámica existente entre la persona y la organización, considerando los principales atributos de la personalidad que influyen en el comportamiento, percepción y personalidad, satisfacción, motivación y desempeño laboral, la subjetividad del perceptor y sus efectos en la dinámica cotidiana de la organización, satisfacción, motivación y desempeño laboral. Introducción a big data y analítica de negocios Al finalizar el curso, los estudiantes sabrán manejar y diferenciar los principales conceptos vinculados a la disciplina de analítica de big data. A saber, conocimiento de las fuentes de big data, principales tecnologías, perfiles y roles, metodologías de análisis e interpretación de datos y regulación de uso y protección de datos.
...
Incorpora competencias generales de liderazgo y el efecto que genera en la motivación y el trabajo colectivo en las organizaciones. Entrena la capacidad de adaptación y la flexibilidad para liderar procesos cotidianos y de cambio. Estudia el mapa de poder en la organización y su impacto en la gestión de la comunicación. Analiza el proceso de negociación y las diferentes estrategias aplicables. Créditos: 4
...
Introduce las herramientas económico-financieras para evaluar las decisiones de marketing y ventas en el corto y largo plazo. Presenta los conceptos fundamentales para la elaboración e interpretación de los estados contables básicos. Introduce las técnicas contables más utilizadas para el análisis financiero. Capacita en las técnicas de evaluación de proyectos comerciales. Créditos: 4

**Omnichannel y trade marketing**

El curso de Omnichannel y Trade Marketing te prepara para entender cómo conectar marcas, distribuidores y consumidores en un mercado cada vez más competitivo. Aprenderás a diseñar canales de distribución centrados en el shopper, a aplicar estrategias de trade marketing desde la visión del fabricante y del distribuidor, y a crear experiencias omnicanal que integren lo mejor del mundo online y offline. Con un enfoque práctico y actual, elaborarás propuestas innovadoras de Route to Market que maximicen la rentabilidad y fortalezcan la relación con distribuidores y consumidores. Créditos: 4
...
Duración Un año y medio de cursos, además de un Proyecto Final (3 clases semanales). Se puede cursar hasta en 3 años (1 o 2 clases semanales). Horarios de clase Frecuencia: martes a jueves de 19:00 a 21:30 horas. Algunas materias contarán con actividad excepcional los días lunes. La Universidad ORT Uruguay se reserva el derecho de realizar ajustes de fechas, horarios y contenidos. Los horarios mencionados no incluyen las prácticas. Las inscripciones están sujetas a quorum mínimo por turno.

## Títulos y reconocimientos

Este título y su título intermedio fueron reconocidos por resolución oficial del Ministerio de Educación y Cultura (MEC) del 2 de setiembre de 2020. Como universidad reconocida y miembro de la Asociación Internacional de Universidades (IAU), los títulos de la Universidad ORT Uruguay cumplen estándares internacionales que permiten continuar estudios de maestría y doctorado en universidades de todo el mundo. Título intermedio (opcional) El Diploma de Especialización en Dirección de Comunicación los acreditará como especialistas en procesos de comunicación empresarial, con capacidades gerenciales y en condiciones de asumir tareas en áreas y departamentos vinculados al campo comunicacional.

## Requisito de graduación

Una vez terminado el postgrado y realizado el proyecto final, los estudiantes reciben el título Master en Dirección de Comunicación y Marketing. Asimismo, al finalizar el primer año es posible optar por realizar un Caso Integrador, que permite obtener el Diploma de Especialización en Dirección de Comunicación.
...
- [Página oficial de la carrera](https://fc.ort.edu.uy/escuela-de-postgrados/master-en-direccion-de-comunicacion-y-marketing)
- [Plan de estudios](https://fc.ort.edu.uy/escuela-de-postgrados/master-en-direccion-de-comunicacion-y-marketing/plan-de-estudios)
