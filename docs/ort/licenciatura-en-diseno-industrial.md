...
- Nombre oficial: Licenciatura en Diseño Industrial
- Tipo: Licenciatura
- Área: Diseño
...
- Cupos: No encontrado
- Título intermedio: Proyectista Industrial
...
- Perfil de egreso: Perfil de los graduados Nuestros graduados desarrollan la capacidad creativa para plantear nuevas propuestas de objetos o bien para reconsiderar objetos existentes, ya sea por cuestiones de mercado, tecnológicas o económicas. La innovación es el pilar fundamental del diseño industrial, siempre teniendo en cuenta al usuario —la persona que hará uso del producto— como el componente técnico —lo que permitirá que el producto sea realizable—. Además, nuestros profesionales están actualizados en todas las técnicas de fabricación digital y en las corrientes de pensamiento del diseño, que se presentan como tendencias.
- Salida laboral: Perfil de los graduados Nuestros graduados desarrollan la capacidad creativa para plantear nuevas propuestas de objetos o bien para reconsiderar objetos existentes, ya sea por cuestiones de mercado, tecnológicas o económicas. La innovación es el pilar fundamental del diseño industrial, siempre teniendo en cuenta al usuario —la persona que hará uso del producto— como el componente técnico —lo que permitirá que el producto sea realizable—. Además, nuestros profesionales están actualizados en todas las técnicas de fabricación digital y en las corrientes de pensamiento del diseño, que se presentan como tendencias.
...
- Página oficial: https://fd.ort.edu.uy/licenciatura-en-diseno-industrial
...
- [Página oficial de la carrera](https://fd.ort.edu.uy/licenciatura-en-diseno-industrial)
- [Plan de estudios](https://fd.ort.edu.uy/licenciatura-en-diseno-industrial/plan-de-estudios)
