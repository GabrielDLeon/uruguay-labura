...
- **minúsculas**, **sin tildes** (`diseno`, no `diseño`), **kebab-case**: guiones como
  separador entre palabras (`comercio-exterior`, no `comercio exterior`).
...
| diseño grafico, diseno grafico | diseno-grafico |
| diseño industrial, diseno industrial | diseno-industrial |
| comercio exterior | comercio-exterior |
| ciencia de datos, data science, analytics, analitica, analisis de datos, analitica de datos, ciencia-de-datos | ciencia-de-datos |
| inteligencia artificial, inteligencia-artificial | inteligencia-artificial |
| salud mental, salud-mental | salud-mental |
| cadena de suministros, supply chain, cadena-de-suministros | cadena-de-suministros |
| gestion de personas, talento humano, talento, gestion de talento, gestion-de-personas | gestion-de-personas |
| recursos humanos, rrhh, recursos-humanos | recursos-humanos |
| marketing digital, marketing-digital | marketing-digital |
| politicas publicas, politicas-publicas | politicas-publicas |
| gestion del cambio, gestion-del-cambio | gestion-del-cambio |
| toma de decisiones, toma-de-decisiones | toma-de-decisiones |
| artes escenicas, artes-escenicas | artes-escenicas |
...
| direccion comercial, direccion-comercial | direccion-comercial |
| educacion inicial, primera infancia, educacion-inicial, primera-infancia | primera-infancia |
...
| relaciones laborales, relaciones-laborales | relaciones-laborales |
| inteligencia emocional, inteligencia-emocional | inteligencia-emocional |
| habilidades gerenciales, habilidades-gerenciales | habilidades-gerenciales |
...
| acompanamiento-terapeutico, acompañamiento-terapeutico | acompanamiento-terapeutico |
